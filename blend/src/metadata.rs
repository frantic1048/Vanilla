...
/// System metadata available to Nickel configs via `import "../metadata.ncl"`.
/// Per-machine values are injected at runtime via Nickel `&` merge — see
/// `nickel::loader::NickelEvaluator::inject_metadata`.
