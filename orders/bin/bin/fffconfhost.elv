...
at-env &host=$hosts[amausaan] &desktop=$desktops[i3] {
    ...
    if (is_xrandr_display_connected "DisplayPort-0") {
        ...
        dispwin -d 1 -I {~}'/.local/share/DisplayCAL/storage/27GL850_#1_2025-09-27_22-08_160cdm²_D6500_2.2_M-S_XYZLUT+MTX/27GL850_#1_2025-09-27_22-08_160cdm²_D6500_2.2_M-S_XYZLUT+MTX.icc'
    ...
    if (is_xrandr_display_connected "DisplayPort-1") {
        ...
        dispwin -d 2 -I {~}'/.local/share/DisplayCAL/storage/SW270C_#2_2025-09-27_21-17_160cdm²_D6500_2.2_F-S_XYZLUT+MTX/SW270C_#2_2025-09-27_21-17_160cdm²_D6500_2.2_F-S_XYZLUT+MTX.icc'
    ...
    if (is_xrandr_display_connected "DisplayPort-0" "DisplayPort-1") {
        ...
        xrandr --output DisplayPort-0 --above DisplayPort-1
    }
